...
@Mapper(
    ...
    imports = {UUID.class, Set.class, RoleEntity.class, StringUtils.class, LocalDateTime.class})
public abstract class UserMapper {
  ...
  @Mapping(
      target = "status",
      expression = "java(ru.rehtang.films.persistence.entity.User.Status.ACTIVE)")
  ...
  @Mapping(
      target = "email",
      expression =
          "java(StringUtils.isNotBlank(dto.getEmail()) ? dto.getEmail() : before.getEmail())")
  @Mapping(
      target = "username",
      expression =
  ...
  @Mapping(
      target = "firstName",
      expression =
          "java(StringUtils.isNotBlank(dto.getFirstName()) ? dto.getFirstName() : before.getFirstName())")
  @Mapping(
      target = "lastName",
      expression =
          "java(StringUtils.isNotBlank(dto.getLastName()) ? dto.getLastName() : before.getLastName())")
